  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={
          currentRole === "admin"
            ? "Create and manage staff logins. Super admin accounts are protected — only a super admin can change them."
                ...
                {rows.length === 0 ? (
                  ...
                  rows.map((user) => {
                    ...
                    const canToggleStatus =
                      !isSuperAdmin &&
                      !(isAdminAccount && currentRole !== "super_admin");
                        ...
                        <td className={BODY_CELL}>
                          {canResetPassword || canToggleStatus ? (
                            ...
                            <span
                              ...
                              title="Only a super admin can manage this account"
                            >
                              Protected account
                            </span>
                          )}
